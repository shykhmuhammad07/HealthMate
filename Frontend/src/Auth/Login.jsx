      ...
      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-7xl gap-28">
        ...
        <div className="space-y-8 max-w-md text-center md:text-left">
          <h2 className="text-4xl font-bold mb-6">
            Stay Fit, Stay <span className="text-green-500">Healthy</span>
          </h2>
          {features.map((item, i) => (
            <div
              key={i}
        ...
        <div className="bg-[#0f0f0f] border border-gray-800 rounded-2xl shadow-2xl p-10 w-full md:w-[420px]">
          <h1 className="text-3xl font-bold text-center mb-3">
            Welcome to <span className="text-green-500">HealthMate</span>
          </h1>
          <p className="text-gray-400 text-center mb-8 text-sm">
            Sign in to track your fitness, diet, and wellness goals.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex justify-between items-center text-sm text-gray-300">
              <label className="flex items-center gap-2">
                <input
                  type="checkbox"
                  className="accent-green-500 bg-gray-800 border-gray-700"
                />
                Remember me
              </label>
            </div>
